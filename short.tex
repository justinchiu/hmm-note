...
\footnote{
The 256 dim FF and LSTM models have comparable computational complexity to the VL-HMM,
...
On \texttt{PTB}, the VL-HMM is able achieve 115.8 perplexity on the test set,
outperforming a FF baseline
and vastly outperforming the 900-state HMM from \citet{buys2018hmm}.
The VL-HMM also outperforms the HMM+RNN extension of \citet{buys2018hmm}.
...
However, the VL-HMM is outperformed by LSTMs.
