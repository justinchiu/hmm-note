...
We also find that the HMM 32k states vastly outperforms the vanilla HMM results from \citet{buys2018hmm},
in addition to the 

However, we find that the HMM underperforms RNN-based models.
This trend persists in \texttt{Wikitext-2},
with the HMM outperforming the 5-gram model at {\color{red}FILL IN} and 210.9 perplexity respectively.
