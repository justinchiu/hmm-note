...
Additionally, we introduce three techniques to do so:
...
and vastly outperforming the 900-state HMM from \citet{buys2018hmm} (284.6).
...
as we found the model needed a larger batch size to train.
