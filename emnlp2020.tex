...
(Compare complexity of forward in LSTM / HMM, matmul for lstm vs matmul for HMM. cost of computing transition matrix is "amortized" over examples)
...
\caption{
\label{fig:hmm}
The HMMs for (a) language modeling and (b) part-of-speech tagging.
We have the words $x_t$, the states $z_t$, and the tags $y_t$.
}
\end{figure}
