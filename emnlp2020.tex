...
We use the same residual network from \citet{kim2019cpcfg} to parameterize conditional distributions.
...
Unstructured dropout was very sensitive to batching strategies.
We observed a large gap 
