...
Due to a lack of conjugacy,
exact inference is intractable in many latent variable sequence models,
especially those with large state spaces. 
We limit our focus to models that permit exact inference,
...
which introduced sparsity constraints in the emission distribution of an HMM.
The sparsity constraints allowed them to train a 30k state HMM on
