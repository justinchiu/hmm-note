...
Discussion 1: Easier when working with sparsity constraints to not instantiate the
full model during training, which makes working with a neural parameterization
beneficial.
%\paragraph{}
